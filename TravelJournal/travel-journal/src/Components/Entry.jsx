    ...
    return (
        <article className="journal-entry">
            ...
            <div className="info-container">
                ...
                <p className="entry-text">Mount Fuji is the tallest mountain in Japan, standing at 3,776 meters 
                (12,380 feet). Mount Fuji is the single most popular tourist site in Japan, for both Japanese 
